	...
	<div class="breadcurb-area">
			<div class="container">
				<ul class="breadcrumb">
					<li><a href="#">Home</a></li>
					<li>Produk</li>
					<li><?php echo ucwords($namakategori) ?></li>
				</ul>
			</div>
		</div>
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-4">
				<div class="product-item-categori">
							<div class="product-type">
								...
								<ul>
									<li><a href="<?php echo SITEURL.'produk' ?>" class="<?php echo (!isset($_GET['act'])) ? 'active' : '' ?>"><i class="fa fa-angle-right"></i>All Produk</a></li>	
									<li><a href="<?php echo SITEURL.'produk/kategori/diskon' ?>" class="<?php echo ($_GET['act'] == 'diskon') ? 'active' : '' ?>"><i class="fa fa-angle-right"></i>Produk Diskon</a></li>	
									<?php foreach ($masterkategori as $row): ?>
									<?php //$katproduk = strtolower($row['nama_kategori']) ; $final = preg_replace('#[ -]+#', '_', $katproduk); ?>
									<li><a href="<?php echo SITEURL. 'produk/kategori/'.$row['id_kategori_produk'] ?>" class="<?php echo ($_GET['act'] == $row['id_kategori_produk']) ? 'active' : '' ?>" ><i class="fa fa-angle-right"></i> <span class="namaKat"><?php echo ucwords($row['nama_kategori'])  ?></span></a></li>	
									<?php endforeach ?>
								</ul>
							</div>
						</div>
			...
			<div class="col-md-9 col-sm-8">
				<div class="product-item-list">
					...
					<div class="row">
							<?php foreach ($masterprodukbykategory as $row): ?>
