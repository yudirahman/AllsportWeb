    	...
    	<div class="row">
				<div class="col-md-9 col-sm-9">
					<div class="product-items-area">
						<h2 class="header-title">Riwayat Order</h2>
						<p>Berikut adalah data riwayat order anda.</p>
		...
		function modalDetail(id){
			...
			$.ajax({
				...
				success : function (res) {
					...
					$('#dataPengirimanModal').html("<tr style=\"vertical-align: middle !important\"><td style=\"vertical-align: middle !important\"><b>To : <br>"+res[0].nama+"<br>"+res[0].alamat+"<br>"+res[0].kota+", "+res[0].provinsi+", Kode Pos  "+res[0].kodepos+"<br>No. HP "+res[0].no_hp+"</b></td>"+
